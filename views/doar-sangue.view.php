...
<form action="../controllers/doar-sangue.controller.php" method="POST">
    <h2>Formulário de Doação de Sangue</h2>
    ...
    <label for="local">Local de Doação:</label>
    ...
    <div class="form-actions">
        <button type="submit" name="acao" value="doar">Doar</button>
